...
'''
Runtime: 116 ms, faster than 98.78% of Python3 online submissions for Missing Number.
Memory Usage: 15.4 MB, less than 50.80% of Python3 online submissions for Missing Number.
'''